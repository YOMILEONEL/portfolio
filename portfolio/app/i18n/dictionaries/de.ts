...
export const de: Dictionary = {
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: "FriendTasks",
        subtitle: "Todo-App für Freundeskreise",
        icon: "📋",
        category: "Fullstack / Produktivitäts-App",
        description:
          "Eine Todo-App für Freundeskreise mit persönlichen Aufgaben, geteilten Gruppen-Listen, einem Wochenkalender und Zuweisungen. Neben klassischen Todos unterstützt sie wiederkehrende Aufgaben, Unteraufgaben, Kommentare, Anhänge und Echtzeit-Benachrichtigungen für die ganze Gruppe.",
        features: [
          "Persönliche und geteilte Gruppen-Todos mit Priorität, Tags, Fälligkeitsdatum sowie Start-/Endzeit",
          "Wiederkehrende Aufgaben (wöchentlich/monatlich) mit Enddatum, mehrfacher Wiederholung pro Woche und Vorkommen-Historie",
          "Wochenkalender mit durchgehenden Balken für mehrstündige Termine und automatischer Aufteilung überlappender Slots",
          "Gruppen mit Einladungslink, Beitrittsfreigabe, schreibgeschützten Mitgliedern und Mehrfachzuweisung",
          "Echtzeit-Updates, Aktivitätsprotokoll, Kommentare, Anhänge sowie gezielte Benachrichtigungen inklusive Sound",
          "Smart Lists (Heute, Diese Woche, Ohne Datum, Alle) mit Suche, Filtern und Dashboard-Kennzahlen",
        ],
        technologies: [
          "Next.js",
          "React",
