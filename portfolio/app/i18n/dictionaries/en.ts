  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "A room booking system with secure user login, role-based authorization and a clean separation between frontend, backend and database.",
        features: [
          "User, room and booking management",
          "CRUD functionality via REST API",
