...
export const en: Dictionary = {
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: "FriendTasks",
        subtitle: "Todo App for Friend Groups",
        icon: "📋",
        category: "Fullstack / Productivity App",
        description:
          "A todo app built for friend groups, combining personal tasks, shared group lists, a weekly calendar and assignments. Beyond classic todos, it supports recurring tasks, subtasks, comments, attachments and real-time notifications for the whole group.",
        features: [
          "Personal and shared group todos with priority, tags, due dates, and start/end times",
          "Recurring tasks (weekly/monthly) with an end date, multiple occurrences per week, and occurrence history",
          "Weekly calendar with continuous bars for multi-hour events and automatic splitting of overlapping slots",
          "Groups with invite links, join approval, read-only members, and multi-assignment of todos",
          "Real-time updates, activity log, comments, attachments, and targeted notifications with sound",
          "Smart lists (Today, This Week, No Date, All) with search, filters, and dashboard metrics",
        ],
        technologies: [
          "Next.js",
          "React",
