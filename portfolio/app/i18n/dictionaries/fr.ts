...
export const fr: Dictionary = {
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: "FriendTasks",
        subtitle: "Application de tâches pour groupes d'amis",
        icon: "📋",
        category: "Fullstack / Application de productivité",
        description:
          "Une application de tâches conçue pour des groupes d'amis, combinant tâches personnelles, listes de groupe partagées, un calendrier hebdomadaire et des assignations. Au-delà des tâches classiques, elle prend en charge les tâches récurrentes, les sous-tâches, les commentaires, les pièces jointes et les notifications en temps réel pour tout le groupe.",
        features: [
          "Tâches personnelles et de groupe partagées avec priorité, tags, date d'échéance et heures de début/fin",
          "Tâches récurrentes (hebdomadaires/mensuelles) avec date de fin, plusieurs occurrences par semaine et historique des occurrences",
          "Calendrier hebdomadaire avec barres continues pour les événements de plusieurs heures et répartition automatique des créneaux qui se chevauchent",
          "Groupes avec lien d'invitation, validation d'adhésion, membres en lecture seule et assignation multiple des tâches",
          "Mises à jour en temps réel, journal d'activité, commentaires, pièces jointes et notifications ciblées avec son",
          "Listes intelligentes (Aujourd'hui, Cette semaine, Sans date, Toutes) avec recherche, filtres et indicateurs du tableau de bord",
        ],
        technologies: [
          "Next.js",
          "React",
